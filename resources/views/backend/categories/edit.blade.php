    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-info">
                <form novalidate id="entryForm" action="{{url('/updateCategoryController/'.$model->id)}}" method="POST"
                            ...
                            <div class="col-md-4">
                                <div class="form-group has-feedback">
                                    ...
                                    <input autofocus type="text" class="form-control" name="name"
                                        placeholder="Tên phân loại" required minlength="2" maxlength="255"
                                        value="{{$model->name}}">
                    ...
                    <div class="box-footer">
                        <a href="/categories" class="btn btn-default">Hủy bỏ</a>
                        <button type="submit" class="btn btn-info pull-right"><i
                                class="fa fa-refresh fa-plus-circle"></i> sửa </button>
